...
class Discussion extends Component {
    ...
    onSubmitClick = () => {
        axios
            .patch(process.env.REACT_APP_HOST + "/api/discussions", {
            ...
            .then(() => {
                this.setState({
                    initialPostTime: dateParser(new Date(), "ddd h:mm a"),
                });
                this.setState({
                    currentPostTime: dateParser(new Date(), "ddd h:mm a"),
                });
