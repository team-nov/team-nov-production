...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    TNOV-19, TNOV-22, TNOV-77, TNOV-78, TNOV-79 are not broken into tasks on Jira
  ...
  - Prioritized	(max 2 marks)
    ...
    Your Mark: 0 All but one story has same priority, even for the ones are not finished
...
## Tracking on Jira  (max 24 marks) 
  - Are all your stories and tasks being worked in this sprint tracked on Active Sprint Board? (max 2 marks)
    ...
    Your Mark: 1
    TNOV-80 is not recorded on Jira sprint
  ...
  - Did you start all stories for sprint 3? (max 2 marks)
    ...
    Your Mark: 1 
    Need more detailed reason on why TNOV-58 and TNOV-78 are not finished
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 2 TNOV-58 not finished
...
Your Mark: 8 / 10
    ...
    NOV-19 half done
    Bug: User appears in dropdown for DM
