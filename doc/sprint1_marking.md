...
**Team Name:** Team Nov   
**Github:** https://github.com/UTSCCSCC01/project-team-nov    
...
## Planning Meetings (RPM.md, sprintN.md) (max 5 marks)
  ...
  - RPM.md (Release Planning Meetings) (max 3 marks)
    ...
    Your Mark: 1
    Feedback: Release goal not specified. User stories provided but no reference to release scope for user stories
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1
    Feedback: Task breakdown not provided. Spikes, user stories and team capacity recorded.
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 1
    Feedback: Some user stories did not have an assigned memeber or subtasks associated to the user story
...
## Tracking on Jira  (max 20 marks) 
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 3
    Feedback: Make sure you ASSIGN someone to the user story or subtask. (Add someone to Assignee; Not just reporter)  
